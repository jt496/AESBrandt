...
// Module: AESBrandt.Operations
// Imports: Init Mathlib.Combinatorics.SimpleGraph.Operations
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_AESBrandt_Operations(uint8_t builtin, lean_object* w) {
lean_object * res;
